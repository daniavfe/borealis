...
class CommunityMeteorologyDownloader():

    def __init__(self, meteorology_configuration:MeteorologyConfiguration, api_client:ApiClient, logger:Logger):
        self.__main_page_url__ :str = meteorology_configuration.community_main_page_url
        self.__download_path__ :str = meteorology_configuration.community_download_path
