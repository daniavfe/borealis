...
Revision ID: 062f9c4eb58b
Revises: 
Create Date: 2021-05-18 19:20:17.547768
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['town_id'], ['towns.town_id'], ),
    sa.PrimaryKeyConstraint('town_id', 'date')
    )
    ...
    sa.ForeignKeyConstraint(['town_id'], ['towns.town_id'], ),
    sa.PrimaryKeyConstraint('town_id', 'district_id', 'neighborhood_id', 'year', 'month')
    )
    ...
    sa.ForeignKeyConstraint(['town_id'], ['towns.town_id'], ),
    sa.PrimaryKeyConstraint('town_id', 'datetime', 'station_id', 'magnitude_id')
    )
